...
export function Hero() {
  return (
    <section
      className="relative mx-auto max-w-7xl overflow-hidden px-5 pb-16 pt-24 text-center sm:px-8 lg:px-10 lg:pb-24 lg:pt-32"
      id="top"
    >
      ...
      <div className="relative mx-auto max-w-4xl">
        <div className="inline-flex items-center gap-2 border border-[#70e8d2]/30 bg-[#251c38]/55 px-3 py-2 font-mono text-[11px] tracking-[.14em] text-[#70e8d2]">
          <span className="size-2 rounded-full bg-[#70e8d2] shadow-[0_0_10px_#70e8d2]" />
          SYSTEM ONLINE
        </div>
        <h1 className="mt-7 font-sans text-4xl sm:text-5xl md:text-6xl font-bold leading-tight tracking-[-.055em]">
        ...
        <p className="mx-auto mt-6 max-w-2xl font-mono text-sm leading-8 text-[#a9a1b8]">
        ...
        <div className="mt-8 flex flex-col sm:flex-row justify-center gap-3">
          <Link
            className="flex items-center justify-center gap-2 bg-[#70e8d2] px-5 py-4 font-mono text-xs font-bold text-[#10231f] shadow-[0_0_22px_rgba(112,232,210,.22)] transition hover:-translate-y-1 hover:bg-[#94f3e0]"
            href="/join"
          >
            Initialize team <ArrowUpRight size={15} />
          </Link>
          <Link
            className="flex items-center justify-center gap-2 border border-[#70e8d2]/45 px-5 py-4 font-mono text-xs text-[#70e8d2] transition hover:-translate-y-1 hover:bg-[#70e8d2]/10"
            href="/teams"
          >
